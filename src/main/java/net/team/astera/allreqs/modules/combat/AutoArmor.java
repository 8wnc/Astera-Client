package net.team.astera.allreqs.modules.combat;
...
import net.team.astera.impl.event.impl.autoarmor.PlayerMotionUpdate;
import net.team.astera.allreqs.modules.Module;

import net.team.astera.impl.util.autoarmor.Timer;
