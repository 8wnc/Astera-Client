...
public final class InventoryUtil {
    ...
    public static void switchTo(int slot) {
        ...
        if (mc.player.getInventory().selectedSlot == slot && AsteraClient.playerManager.serverSideSlot == slot) return;
    ...
    public static float getHitDamage(@NotNull ItemStack weapon, PlayerEntity ent) {
        ...
        /*if (mc.player.fallDistance > 0 || net.team.AsteraClient.manager.ModuleManager.criticals.isEnabled())*/ //Posible error sword totem
