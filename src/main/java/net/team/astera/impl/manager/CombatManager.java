...
import net.team.astera.impl.event.impl.autototem.EventPostSync;
import net.team.astera.impl.event.impl.autototem.TotemPopEvent;
import net.team.astera.AsteraClient;
import net.team.astera.impl.event.impl.cracked.PacketEvent;
import static net.team.astera.impl.util.traits.Util.mc;
import static net.team.astera.impl.util.traits.Util.EVENT_BUS;
import static net.team.astera.allreqs.Feature.fullNullCheck;
...
public class CombatManager implements IManager {
    ...
    public List<PlayerEntity> getTargets(float range) {
        return mc.world.getPlayers().stream()
                .filter(e -> !e.isDead())
                .filter(entityPlayer -> !AsteraClient.friendManager.isFriend(entityPlayer.getName().getString()))
